...
# PASCAL PORT: torch.fx._graph_pickler.Options is torch >= 2.8. Guard the
# import; these helpers are only exercised by torch.compile caching, which is
# disabled on the Pascal (enforce-eager) deployment.
try:
    ...
    try:
        ...
        GraphPickler = None  # type: ignore[assignment]
