...
class Attention(nn.Module, AttentionLayerBase):
    ...
    def forward(
        ...
        if output_shape is None:
            ...
            # PASCAL PORT: a plain tuple, not torch.Size.  torch 2.7's dynamo
            # cannot trace the torch.Size constructor ("Dynamo does not know
            # how to trace the function <class 'torch.Size'>"), and this value
            # is only ever handed to torch.empty and indexed -- both of which
            # take a tuple just as happily.
