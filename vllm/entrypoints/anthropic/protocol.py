...
class AnthropicMessage(BaseModel):
    ...
    # Harnesses (e.g. the Claude Code / 1Cat harness) may inject synthetic
    # "system" role messages inside `messages` before the first user message,
    # so the role must not be restricted to user/assistant.
    role: str
