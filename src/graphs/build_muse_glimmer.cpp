...
ggml_cgraph * llm_build_context::build_muse_glimmer() {
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            // 2026-08-17: the hint is passed again for sliding-cache layers. The reason it was
            // suppressed -- the CPU iqk path slicing K/V/mask by INDEX -- is gone: that slice
            // is now mask-driven and correct for a floating/wrapping band. Passing it again
            // restores the CUDA
