...
# the vLLM build this sidecar targets (written against torch 2.10) calls.
# Loaded in every vllm process via PYTHONPATH. Each shim maps to the
# torch.cuda equivalent.
# ---------------------------------------------------------------------------
try:
