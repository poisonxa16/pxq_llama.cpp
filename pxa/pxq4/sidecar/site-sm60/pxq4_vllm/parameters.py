...
Component B ("runtime"), design note ``09-chosen-design.md`` §6.4.
...
------------------------------------------------------------------------------
Design note §3.1 invariant: every vLLM linear module served by PXQ4 is
...
the invariant has been broken -- stop and re-read §3.1.  (The concrete
