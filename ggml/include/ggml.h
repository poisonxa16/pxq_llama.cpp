...
extern "C" {
    ...
    // True if the (up, gate) expert type pair can ride GGML_OP_MOE_FUSED_UP_GATE:
    // same type, or a PXQ-UNIVERSAL mixed pair {PXQ2, PXQ3, PXQ6} x {PXQ2, PXQ3, PXQ6}
    // (the CUDA fused-MoE kernels take independent per-operand policies for those;
