...
quant type varies. KLD against the true bf16 merge source was measured on 2026-07-18 and is
monotonic in the same order — mean KLD 0.0560 (PXQ4) / 0.0758 (PXQ3) / 0.2054 (PXQ2), with
89.4% / 87.8% / 80.3% top-1 agreement. Full protocol and results in
[`KLD-RESULTS.md`](KLD-RESULTS.md); `kld.sh` is the exact procedure if you want to rerun it.
...
- **`PXA_G2_ADDFUSE=1` (late 2026-07-19, bit-exact):** residual-add fusion measured on top of
  ...
  and REDFUSE measured a loss — all stay in-tree default-OFF.

## Model files

The tiers are published at `huggingface.co/poisonxa/PXA-Fusion4-35B-GGUF`
