...
|---|---|---|---|---|---|---|---|
| **PXQ6** | 4.27 bpw | 7.36 | **0.0560 ± 0.0007** | 0.0308 | 1.292 | **89.4%** | 6.36% |
...
run. Within this KLD run the derived per-tier ppl (bf16 × e^(mean lnΔ)) is PXQ6 7.33 / PXQ3 7.40 /
PXQ2 8.31 — consistent with the ladder.

**Reading it:** KLD is **monotonic** and tracks the ppl ladder. PXQ6 (4-bit) diverges from bf16 by
...
Raw logs on the box: `/root/pxq-kld/kld-{PXQ6,PXQ3,PXQ2}-pxqu.log`; base dump `/root/pxq-kld/base.log`.
