...
// From a captured kimi-k2 tool-calling session (LS tool, streamed response)
...
void test_contamination_reproduction() {
    ...
    // Test 1: Exact issue from the captured kimi-k2 LS tool-calling session
...
void test_qwen3_model_detection() {
    ...
    std::vector<std::string> non_qwen3_models = {
        "llama-7b", "gpt-4", "phi-3", "mistral-7b", "qwen-2", "qwen", "qwen2-7b"
    };
