...
The four cards under test were checked for a hardware handicap and are clean: max clocks, no throttle
reasons, NVLink pattern identical to the host's other four-card group.
