...
Date: 2026-08-18. Hardware: V100-SXM2-32GB (sm_70, 80 SMs, ~900 GB/s HBM2).
...
on a single V100 (parity, microbench, ncu) or on a four-card V100 group (serving); nothing here is projected
...
Nothing about the fold order changed, and it is gated four ways:
  ...
  * device, single V100: **120/120 shape/M/vecx combos bit-exact** (12 real TP4/TP2/TP1 shapes
...
**No capture regression.** The first v5 row is a measurement artifact, and was nearly reported
...
## End-to-end TP=4, CUDA graphs — and why it cannot settle a 10% question on this rig
