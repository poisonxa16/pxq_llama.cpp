...
// (a community sm_70 fork of vLLM) already owns `torch.ops._C` with 54 registered sm70 ops,
...
// the runtime package (`src/pxq4_vllm/ops.py`) via torch.library.register_fake.
