...
==============================================================================
A "PXQ4" GGUF is not uniformly PXQ4.  Backbone rev 2 (gguf KV
...
==============================================================================
VERIFIED FACTS THIS FILE DEPENDS ON (all read in the community sm_70 vLLM fork, git 2ceb15066)
==============================================================================
...
class PXQ4LinearMethod(LinearMethodBase):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        # params). Standard torch behaviour; not executed here
        # because no torch need be installed on the machine this is authored on.
    ...
    def apply(
        ...
        if getattr(layer, "pxq4_linear_op", False):
            ...
            # tested on a GPU here -- that is gate G8. Fallback:
