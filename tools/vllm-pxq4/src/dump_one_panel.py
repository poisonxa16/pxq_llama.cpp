...
# Read-only; touches nothing but the file. Runs anywhere (python3 + stdlib only).
#
# usage:  PXQ4_GGUF=/path/to/model-PXQ4.gguf python3 dump_one_panel.py [tensor-name]
import base64, os, struct, sys

PATH = os.environ.get("PXQ4_GGUF")
if not PATH:
    sys.exit("set PXQ4_GGUF to the PXQ4 .gguf artifact to read")
