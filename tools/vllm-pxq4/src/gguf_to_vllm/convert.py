        ...
        if "{e}" in hf:
            ...
            if not NM.is_pxq4_module(module, policy):
                raise SystemExit(
                    ...
                    f"3.4x-over-VRAM failure this converter exists to prevent -- "
...
def run_convert(args) -> int:
    ...
    # with no access to the V100 host. It is refused for a real conversion: emitting tensor data from a
