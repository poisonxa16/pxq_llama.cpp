...
Deliberately does NOT require pytest: these gates have to be runnable on the V100 host inside a
throwaway container with nothing installed but numpy, and inside a serving container
