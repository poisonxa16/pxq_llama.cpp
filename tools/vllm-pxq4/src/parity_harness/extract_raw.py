...
Same job as extract.py, but with zero third-party imports, because the host that holds the
14.6 GiB artifact does not necessarily have numpy (that host may not), and the only
python that does live inside a serving container that must not be disturbed.
