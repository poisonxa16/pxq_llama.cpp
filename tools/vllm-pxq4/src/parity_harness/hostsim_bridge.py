"""
hostsim_bridge.py -- drive the real kernel on the CPU, via ctypes, with no GPU.
...
kernel gates -- which the plan schedules as G6/G8, behind a GPU -- can be run
...
whole shard-then-dequant invariant, all in the kernel's own code.
