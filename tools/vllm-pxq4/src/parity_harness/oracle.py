...
to the converter: a parity harness that only compares the converter's reference against the kernel's
...
`cref/` (which compiles the ACTUAL engine C) makes it four-way with the shipping engine.
