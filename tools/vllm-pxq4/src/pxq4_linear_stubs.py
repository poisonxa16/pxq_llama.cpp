...
exercised on a machine with neither torch nor vLLM installed, and with no GPU.

Everything here is a transcription of code that was READ in the community sm_70 vLLM fork
