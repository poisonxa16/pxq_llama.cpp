...
// (from pxq_llama src/pxq6-quantize.inc.cpp, shipped verbatim) as the frozen ABI required by
...
// Determined from the dispatch in pxq_llama src/llama-quantize.cpp:2624
...
// Copied verbatim from pxq_llama src/llama-quantize.cpp:1049-1062 (needed by
